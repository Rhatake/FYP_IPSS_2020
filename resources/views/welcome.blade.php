...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<div class="layout">
		...
		<div class="gallery">
			...
			<img src="img/b1.jpg" alt="Cinque Terre" width="600" height="400"></a>
			<div class="desc">Monitoring The Risky Areas</div>
		</div>

		<div class="gallery">
		<a target="_blank" href="img_forest.jpg">
		<img src="img/s3.jpg" alt="Forest" width="600" height="400">
		</a>
			<div class="desc">Prevention Maintainence</div>
		</div>

		<div class="gallery">
		<a target="_blank" href="img_lights.jpg">
		<img src="img/s1.jpg" alt="Northern Lights" width="600" height="400">
		</a>
		<div class="desc">Team on Daily Service</div>
		</div>
	</div>
